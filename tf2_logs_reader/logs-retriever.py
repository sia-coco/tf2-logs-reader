...
if __name__ == '__main__':
    ...
    clean_params = {"split_trusted":False, "time_frame":[1605394800, None], "player_frame":[12, 12], "map_frame":cfg.CP_MAPS}
    
    
    # Mystt data
    # clean_params = {"split_trusted":False, "time_frame":[1606854613, 1606861813], "player_frame":[12, 13], "map_frame":cfg.SIXIES_MAPS}
